...
df %<>%
  ...
  mutate(`Areas de barrios`=ifelse(is.na(`Areas de barrios`),median(`Areas de barrios`,na.rm = TRUE),`Areas de barrios`))%>%
  ungroup() #No funciona ya que todos los NAs que quedan son los que no tienen Indice de Vulnerabilidad
```
